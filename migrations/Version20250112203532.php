 ...
 */
final class Version20250112203532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id CHAR(36) NOT NULL, owner_id CHAR(36) DEFAULT NULL, buyer_id CHAR(36) DEFAULT NULL, name VARCHAR(100) NOT NULL, description VARCHAR(1500) DEFAULT NULL, area_ha NUMERIC(10, 2) NOT NULL, quantity NUMERIC(10, 2) NOT NULL, price NUMERIC(10, 2) NOT NULL, project_type VARCHAR(255) DEFAULT NULL, created_on DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_on DATETIME NOT NULL, is_active TINYINT(1) NOT NULL, INDEX IDX_2FB3D0EE7E3C61F9 (owner_id), INDEX IDX_2FB3D0EE6C755722 (buyer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
